...
int main(int argc, char ** argv) {
    ...
    printf("Start.\n");
    ros::init(argc, argv, "hydra_joy_node");
    ros::NodeHandle nh;
    ros::Publisher pub = nh.advertise<sensor_msgs::Joy>("/hydra_joy", 10, false);
    sensor_msgs::Joy msg;
    msg.axes.resize(3);
    ...
    while ( keepRunning ) {
        ...
        std::memcpy(msg.axes.data(), allControllerData.controllers[0].pos, sizeof (float)*3);
        pub.publish(msg);
